    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                $name = 'Sos';
                $a = '';
                if (auth()->user()->can('sos-numbers.edit')) {
                    $a .= '<a href="' . route('sos-numbers.edit', $query->id) . '" class="btn btn-outline-info btn-sm" title="Edit "' . $name . '><i class="ri-edit-box-line"></i></a>';
                }
                if (auth()->user()->can('sos-numbers.destroy')) {
