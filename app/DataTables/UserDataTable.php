        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                ...
                if (auth()->user()->can('users.edit')) {
                    $a .= '<a href="' . route('users.edit', $query->id) . '" class="btn btn-outline-info btn-sm" title="Edit ' . $name . '?"><i class="ri-edit-box-line"></i></a> ';
                }
                if (auth()->user()->can('users.permission.edit')) {
                    $a .= '<a href="' . route('users.permission.edit', $query->id) . '" class="btn btn-outline-primary btn-sm" title="Edit ' . $name . ' Permission"><i class="ri-key-2-fill"></i></a> ';
                }
