            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body pt-3">
                        <form class="row g-3" enctype="multipart/form-data" action="{{ route($route . '.store') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="password" type="password" name="password"
                                    ...
                                    value="{{ old('password') }}" placeholder="@lang('admin_fields.password')" autocomplete="password">
                                @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
