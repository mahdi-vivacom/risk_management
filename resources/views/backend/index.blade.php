...
@section('content')
     ...
     <section class="section dashboard">
        <div class="row">
            <!-- Left side columns -->
            <div class="col-lg-6" style="border: 1px solid #EAEAEAFF">
                <div class="row">
...
{{--                            <span class="text-success small pt-1 fw-bold">8%</span> <span class="text-muted small pt-2 ps-1">increase</span>--}}
                ...
                <div class="col-xxl-6 col-xl-6 col-md-6">
                    ...
                    <div class="card info-card customers-card bg-c-green">
...
{{--                                        <span class="text-danger small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">decrease</span>--}}
                ...
                <!-- Customers Card -->
                <div class="col-xxl-6 col-xl-6 col-md-6">
                    <div class="card info-card customers-card bg-c-blue">
                        <div class="card-body">
...
{{--                </div><!-- End Top Selling -->--}}
            ...
            <div class="col-lg-6" style="border: 1px solid #EAEAEAFF; border-left: none;">
                <div class="row">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-md-6">
                        <div class="card info-card sales-card bg-c-blue">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">@lang('admin_fields.total')</h5>
