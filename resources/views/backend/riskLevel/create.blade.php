                        ...
                        <form class="row g-3" action="{{ route($route . '.store') }}" method="post" novalidate>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="level" type="text" name="level"
                                    ...
                                    placeholder="@lang('admin_fields.risk_level')" autocomplete="level">
                                @error('level')
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="score_min" type="number" name="score_min"
                                    ...
                                    value="{{ old('score_min') }}" placeholder="@lang('admin_fields.score_min')" autocomplete="score_min">
                                @error('score_min')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="score_max" type="number" name="score_max"
                                    ...
                                    value="{{ old('score_max') }}" placeholder="@lang('admin_fields.score_max')" autocomplete="score_max">
                                @error('score_max')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="action" type="text" name="action" class="form-control @error('action') is-invalid @enderror">{{ old('action') }}</textarea>
                                @error('action')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
