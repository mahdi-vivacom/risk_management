            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body pt-3">
                        <form class="row g-3" action="{{ route($route . '.update', $info->id) }}" method="post" novalidate>
                            @csrf
                            @method('patch')
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="score" type="number" name="score"
                                    ...
                                    value="{{ old('score', $info->score) }}" placeholder="@lang('admin_fields.score')"
                                    autocomplete="score">
                                @error('score')
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="name" type="text" name="name"
                                    ...
                                    value="{{ old('name', $info->name) }}" placeholder="{{ $type }}"
                                    autocomplete="name">
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="definition" name="definition" class="form-control @error('definition') is-invalid @enderror">{{ old('definition', $info->definition) }}</textarea>
                                @error('definition')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
