        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body pt-3">
                    <form class="row g-3" action="{{ route ( $route . '.update', [ 'commission' => $commission->id ] ) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="amount" type="text" name="amount"
                                ...
                                placeholder="@lang( 'admin_fields.amount' )" autocomplete="amount">
                            @error( 'amount' )
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="1">@lang ( 'admin_fields.active' )</option>
