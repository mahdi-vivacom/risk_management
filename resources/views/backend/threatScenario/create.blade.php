                        ...
                        <form class="row g-3" action="{{ route($route . '.store') }}" method="post" novalidate>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="type" id="type"
                                    ...
                                    <option value="Threat to movement" selected>Threat to movement</option>
                                    <option value="Threat to work site">Threat to work site</option>
                                    <option value="Threat to local population">Threat to local population</option>
                                </select>
                                @error('type')
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="name" type="text" name="name"
                                    ...
                                    placeholder="@lang('admin_fields.threat_type')" autocomplete="name">
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="definition" name="definition" class="form-control @error('definition') is-invalid @enderror"
                                    rows="5">{{ old('definition') }}</textarea>
                                @error('definition')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
