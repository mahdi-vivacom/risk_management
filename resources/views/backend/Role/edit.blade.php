...
@section('content')
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form action="{{ route($route . '.update', ['role' => $role->id]) }}" method="post" novalidate>
                        @csrf
                        @method('patch')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input name="display_name"
                                        ...
                                        value="{{ old('display_name', $role->display_name) }}" placeholder="Display Name"
                            ...
                            <div class="row mt-4">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan=2 class="text-center">{{ __('No module available yet.') }}
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
